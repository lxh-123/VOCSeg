...
def inference(hypes, images, train=True):
    ...
    vgg_fcn = fcn16_vgg.FCN8VGG(vgg16_npy_path=vgg16_npy_path)

    vgg_fcn.wd = hypes['wd']

    vgg_fcn.build(images, train=train, num_classes=21, random_init_fc8=True)
